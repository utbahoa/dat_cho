    ...
    <>
      ...
      <View style={{ backgroundColor: 'red' }}>
        <View style={styles.header}>
          ...
          <View style={{
            ...
            <TextInput style={{ flex: 1 }} placeholderTextColor="#000" placeholder="Tìm nhà hàng, đặt chỗ..."></TextInput>
        ...
        <Text style={{ paddingHorizontal: 10, color: '#fff', marginVertical: 5, fontSize: 15 }}>Đặt bàn - Đặt chỗ cho hôm nay 15:00, 2 người lớn </Text>
      </View>
      <ScrollView style={{ flex: 1 }}>
        ...
        <FlatList
            ...
            renderItem={
              ({ item }) => (
                <View style={{ marginRight: 10, marginVertical: 0, alignItems: 'center', marginRight: 33 }}>
        ...
        <View style={{ flexDirection: 'column', marginHorizontal: 10, marginTop: 15 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <Text>Bo suu tap</Text>
            <View style={{ flexDirection: 'row' }}>
              <Text style={{ marginRight: 10 }}>xem them</Text>
        ...
        <View>
          {
            DATA1.map((item) => {
              return (
                <View key={item.id} style={{ marginRight: 10, margin: 5, flexDirection: 'row' }}>
                  <Image source={{ uri: item.img }} style={{ height: 80, width: 80 }}></Image>
                  <View style={{ flexDirection: 'column', marginLeft: 10 }}>
                    
                    <Text style={{ color: 'blue'}}>Quán ngon học đường- SUUS</Text>
                    <Text>23 Tôn Đức Thắng</Text>
                    <Text>Quán ăn/ sinh nhật</Text>
                    <View style={{ paddingLeft: 5, marginTop: 5, fontSize: 5, borderRadius: 20, flexDirection: 'row' }}>
                      <Text style={{ color: 'red' }}>Giảm 15%</Text>
                    </View>
                  </View>
                </View>
              )
